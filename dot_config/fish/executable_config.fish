...
alias lsgitpkg='pacman -Q | grep -i "\-git" | wc -l' # List amount of -git packages
...
alias recentinstalledpkg="expac --timefmt='%Y-%m-%d %T' '%l\t%n %v' | sort | tail -200 | nl"
...
# Enable Catppuccin theme to work in Micro
